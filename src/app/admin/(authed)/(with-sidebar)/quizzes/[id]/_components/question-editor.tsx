...
// 4-choice MCQ editor for standalone quizzes. Mirrors the case-attached
// question editor but uses the quizId-based actions (no caseId+scope).
export function QuestionEditor({
  ...
  const handleSave = () => {
    ...
    startSave(async () => {
      const result = question
        ...
        : await createQuizQuestion({ quizId, draft });
      if (!result.ok) {
  ...
  return (
    <div className="border border-rule-strong bg-surface rounded-[2px] p-6 mb-3">
      ...
      <div className="mt-6">
        <FieldLabel>Choices · mark one correct · 2–4 allowed</FieldLabel>
